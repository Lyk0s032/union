...
export default function ItemNecesidadMPMT({
    item,
    medConsumo,
    necesidad,
    entregado,
    ...
    console.log('cantidadNecesaria2', cantidadNecesaria2)
    console.log('formatoNecesidad', formatoNecesidad)
    console.log('item en mt', item)
