...
export default function UpdateClient(){
    ...
    const [form, setForm] = useState({
        nit:client.nit.split('-')[0],
        persona:  client.type,
        code: client.nit.split('-')[1],
    ...
    const updateClient = async() => {
        ...
        if(!form.nit || !form.email || !form.direccion || !form.ciudad || !form.departamento || !form.pais || !form.fijo || !form.phone){
            ...
            .then((res) => {
                ...
                // dispatch(actions.axiosToGetClient(false, res.data));
                params.delete('c');
                setParams(params);
            }).catch(err => {
    ...
    return (
        <div className="modal">
            ...
            <div className="containerModal">
                <div className="top">
                    <h3>
                        Actualizar cliente - {client.nombre}
                    </h3>
                </div>
                <div className="bodyModal">
                    <div className="form">
                        ...
                        <div className="inputDiv">
                            {
                                !loading ?
                                <button className="create" onClick={() => updateClient()}>
