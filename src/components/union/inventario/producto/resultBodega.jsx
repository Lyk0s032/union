...
export default function ResultBodegaProducto({ item }){
    ...
    useEffect(() => {
        if(params.get('show') == 'Bodega'){
            if(params.get('who') == '1' || params.get('who') == '4'){
                dispatch(actions.axiosToGetItemMateriaPrimaBodega(true, params.get('item'), params.get('who') ?  params.get('who') : 1))
            }
        }
